...
export const api = {
  ...
  getBackgroundStatus: () => request('/execution/background/status'),
  pauseBackgroundServices: () => request('/execution/background/pause', { method: 'POST' }),
  resumeBackgroundServices: () => request('/execution/background/resume', { method: 'POST' }),
